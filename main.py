...
plat_img=pygame.image.load("images/launcher.png").convert_alpha()
...
class Platform(pygame.sprite.Sprite):
    def __init__(self,x,y,width):
        ...
        self.image=pygame.transform.scale(plat_img,(width,12))
        self.rect=self.image.get_rect()
        self.rect.x=x
        self.rect.y=y
...
while run:
    ...
    if game_over==False:
        ...
        draw_text("SCORE:"+str(score),font_small,black,150,250)
